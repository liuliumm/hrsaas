import { loginApi, logout, getUserInfo, getUserDetailById, } from '@/api/user'
...
const actions = {
  ...
  async login(context, data) {
    //注意这个loginApi是从api/user.js中导入的  loginApi执行完毕将data传递给登录页面的登录函数里的data
  ...
  // get user info
  // 获取用户资料action   下代码是异步操作，放入actions中
