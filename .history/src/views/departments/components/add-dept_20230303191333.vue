...
<script>
import { getDepartments, addDepartments, getDepartmentsById, editDepartmentById } from "@/api/departments";
    ...
    btnOK() {
      ...
      this.$refs.deptForm.validate(async (isOK) => {
        if (isOK) {
          ...
          try {
            if (this.formData.id) {
              await editDepartmentById({...this.formData, pid: this.treeNode.id});
            } else {
